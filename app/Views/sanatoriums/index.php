...
<div class="breadcrumb-section mb-130"><div class="container"><ul class="breadcrumb-list">
    <li><a href="<?= url() ?>"><?= e(t('common.breadcrumb.home')) ?></a></li><li><span><?= e(t('nav.sanatoriums')) ?></span></li>
</ul></div></div>
<section class="list-section mb-130"><div class="container">
    <div class="row mb-60"><div class="col-12 text-center"><h1><?= e(t('nav.sanatoriums')) ?></h1></div></div>
    <div class="row gy-5">
    <?php foreach ($items as $item): ?>
        <div class="col-lg-4 col-md-6">
            <div class="item-card" style="border:1px solid #eee;border-radius:12px;overflow:hidden;">
                ...
                <?php endif; ?>
                <div class="p-3">
                    <h4><a href="<?= e(url('sanatoriums/' . $item['slug'])) ?>"><?= e($item['title_' . $locale] ?: $item['title_ru'] ?? $item['name_' . $locale] ?? '') ?></a></h4>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
